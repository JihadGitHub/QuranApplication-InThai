...
Route::get('/quran/random', [QuransController::class, 'random'])->name('random');
...
Route::get('/random', [SearchController::class, 'random'])->name('web.random');
Route::get('/random_enduser', [SearchController::class, 'random_enduser'])->name('web.random_enduser');
//adminmanagenote
...
Route::get('/enduser/random', [QuranController::class, 'random'])->name('ramdom_enduser');
