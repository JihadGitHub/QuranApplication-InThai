...

{
    ...
    if(Auth::id()){
        $userid=Auth::user()->id;
        $tafseers = Random::where('user_id',$userid)->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Random $tafseer)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Random $tafseer)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Random $tafseer)
    {
        $request->validate([
            'name' => 'required',
            'datasurah_id' => 'required',
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Random $tafseer)
    {
        $tafseer->delete();
        return back();
    }
